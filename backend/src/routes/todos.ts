...
todosRouter.patch("/", async (
    request: Request<{}, UpdateTodoResponse | ErrorResponse, UpdateTodoRequest>,
...
todosRouter.delete("/", async (
    request: Request<{}, DeleteTodoResponse | ErrorResponse, DeleteTodoRequest>,
